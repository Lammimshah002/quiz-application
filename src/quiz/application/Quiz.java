...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name)
    {
        ...
        ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("icon/quiz.jpg")); //component banichi
        ...
        qno.setFont(new Font("Tahema",Font.PLAIN,24));
        add(qno);
        question =new JLabel("");
        question.setBounds(150,450,900,30);
        question.setFont(new Font("Tahema",Font.PLAIN,24));
        add(question);
